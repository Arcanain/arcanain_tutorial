...
class TFPointCloudSubscriber : public rclcpp::Node
{
public:
  TFPointCloudSubscriber()
  : Node("tf_base_link_sub")
  {
    subscription_ = this->create_subscription<sensor_msgs::msg::PointCloud>(
      "transformed_point_cloud", 10,
      std::bind(&TFPointCloudSubscriber::pointCloudCallback, this, std::placeholders::_1));
  }
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<TFPointCloudSubscriber>());
  rclcpp::shutdown();
  return 0;
}
